package com.quickgit.desktop.data.github

import com.quickgit.desktop.data.AppLog
import com.quickgit.desktop.data.models.GitHubRemoteRepo
import com.quickgit.desktop.data.models.Issue
import com.quickgit.desktop.data.models.MergeMethod
import com.quickgit.desktop.data.models.PrComment
import com.quickgit.desktop.data.models.PrOpResult
import com.quickgit.desktop.data.models.PullRequest
...
import com.quickgit.desktop.data.models.WorkflowStep
    ...
    private fun downloadTextFollowingRedirects(path: String, maxBytes: Int = 2_000_000): String {
        ...
        while (redirects < 8) {
            ...
            try {
                ...
                // Auth only needed for api.github.com hops; blob URLs are pre-signed.
