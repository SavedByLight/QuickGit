...
- **Large screens / Chromebooks** — resizeable multi-window and freeform support; Material3 window size classes; adaptive content width and padding; optional permanent left NavigationRail matching the Linux desktop app (Repos / Clone / Browse / Profile / Users / Logs / Settings). Toggle under Settings → Layout: Auto (by window width), Always, or Never (touchscreen not required)
